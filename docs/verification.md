...
These are local build and simulator/emulator results. Physical devices, biometric lockout, iOS passcode fallback, older supported OS versions, and minified Android release apps have not been tested.
